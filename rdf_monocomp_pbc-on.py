...
def user_input():
    ...
    return total_frames, Lx, Ly, Lz, nAtTot, xyz_all, at, nAt, dr, Rcut, file_out
...
def sample(Lx, Ly, Lz, xyz, dr, Rcut, RDF, nAt):
    Rcut2 = Rcut * Rcut
...
def normalize(Lx, Ly, Lz, nAt, dr, nBin, frames_count, RDF, file_out):
    '''
...
def main():
    ...
    total_frames, Lx, Ly, Lz, nAtTot, xyz_all, at, nAt, dr, Rcut, file_out = user_input()
    ...
    for frame in range(total_frames):
        ...
        sample(Lx, Ly, Lz, xyz, dr, Rcut, RDF, nAt)
        frames_count += 1

    normalize(Lx, Ly, Lz, nAt, dr, nBin, frames_count, RDF, file_out)
